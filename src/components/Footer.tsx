        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link to="/">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xl font-bold">VKMS (PVT) LTD</span>
              </div>
            </Link>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                📞 <a href="tel:0769780984" className="hover:text-blue-400 transition-colors">
                  070 533 9370
                </a>
              </li>
              <li>
                📧 <a href="mailto:vkms@kectholdings.com" className="hover:text-blue-400 transition-colors">
                  vkms@kectholdings.com
                </a>
              </li>
            </ul>
          </div>
